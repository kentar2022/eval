...
<head>
    ...
    <style>
        .custom-bg-gray { background-color: #434B4D !important; }
        .block { width: 400px; height: 800px; margin: 20px; padding: 20px; background-color: #F8F8FF; }
        .btn_submit { background-color: #C5001A; border: none; margin: 20px 0px 40px 0px; }
        .glav { display: flex; justify-content: space-evenly; }
        h1 { color: #C5001A; font-size: 28px; }
    </style>
</head>
<body class="custom-bg-gray">
    <div class="glav">
        <div class="block">
            ...
            <button type="submit" class="btn btn-primary btn_submit">Envoyer l'image et poster l'annonce</button>
            </form>
        </div>
    </div>
    ...
    <div class="registration-block block">
        <div class="col-md-12">
            ...
            <form method="POST" action="create_worker.php">
                <label for="worker_email">Email:</label><br>
                <input type="email" id="worker_email" name="worker_email" required><br>
                <label for="worker_password">Mot de passe:</label><br>
                <input type="password" id="worker_password" name="worker_password" required><br><br>
                <input type="submit" value="Enregister les données">
            </form>
        </div>
    </div>
